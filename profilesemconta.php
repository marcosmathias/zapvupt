...
<p class="carrinho" id="welcome" style="color:#ffffff; position:absolute; margin-left: 20vw; margin-top: 10vh; font-size: xx-large; font-family: KozukaGothicPro-ExtraLight">Bem-vindo, <span style="font-family: KozukaGothicPro-Bold"><?php echo $nome; ?>.</span></p>
...
<img class="carrinho" id="carrinho" style="width:50vw; position: absolute; margin-left: 25vw; margin-top:40vh" src="/img/carrinho.png" />
...
<div class="catalogo" id="produtos" style="position: absolute; margin-top: 30vh; margin-left:15vw; width: 75vw; height: 15vh; text-align: center; display: none;">
	<div class="catalogo" id="produto1" style="float:left; margin-top: 5vh; margin-left: 2vw; width: 20vw; height: 40vh; background-color: rgba(255,255,255,0.7);">
		...
		<img class="catalogo" id="adicionar_produto1" style="float: left; width: 10vw; margin-left: 5vw; margin-top: 5vh;" src="/img/adicionar_ao_carrinho.png" />
	</div>
	<div class="catalogo" id="produto2" style="float:left; margin-top: 5vh; margin-left: 2vw; width: 20vw; height: 40vh; background-color: rgba(255,255,255,0.7);">
		...
		<img class="catalogo" id="adicionar_produto2" style="float: left; width: 10vw; margin-left: 5vw; margin-top: 5vh;" src="/img/adicionar_ao_carrinho.png" />
	</div>
	<div class="catalogo" id="produto3" style="float:left; margin-top: 5vh; margin-left: 2vw; width: 20vw; height: 40vh; background-color: rgba(255,255,255,0.7);">
		...
		<p class="catalogo" style="float: left; margin-top:5vh; color: #bb0000; margin-left: -9.5vw; font-family: KozukaGothicPro-Bold;">Peso:</p><select id="peso_produto3" size=1 style="margin-top: -1vh; color:#106492; float: left; margin-left: 8.5vw; font-family: KozukaGothicPro-Bold;"><OPTION>1</select>
		<img class="catalogo" id="adicionar_produto3" style="float: left; width: 10vw; margin-left: 5vw; margin-top: 5vh;" src="/img/adicionar_ao_carrinho.png" />
	</div>
</div>
		...
		<img class="carrinho" id="finalizar_botao" style="position: absolute; float: left; width: 20vw; margin-left: 75vw; margin-top: 75vh;" src="/img/finalizar_pedido.png" />
